#ifndef _DISPLAY_TEST_
#define _DISPLAY_TEST_
...
void testfastlines (Adafruit_ST7735* tft, uint16_t colorl, uint16_t color2);
void testdrawrects (Adafruit_ST7735* tft, uint16_t color);
void testfillrects(Adafruit_ST7735* tft, uint16_t colorl, uint16_t color2);
...
void setupDisplay(Adafruit_ST7735* tft);
void displayLoop(Adafruit_ST7735* tft);
...
void testdrawtext(Adafruit_ST7735* tft, String text, uint16_t font_color, uint16_t background_color) {
